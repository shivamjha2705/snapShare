      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:4/5 w-full'>
        <div className='bg-secondaryColor p-3 flex flex-0.7 w-full '>
          <div className='flex justify-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
            {loading && <Spinner />}
            {wrongImageType && <p className='flex text-center justify-center font-bold text-2xl text-red-700 bg-white'>Wrong image type</p>}
            {!imageAsset ? (
              <label>
        ...
        <div className='flex flex-col flex-1 gap-6 lg:pl-5 mt-5 w-full '>
          ...
          <input
            ...
            className='outline-none text-2xl text-base sm:text-lg  border-b-2 border-gray-200 p-2'
          />
          <input
            type='text'
            value={destination}
