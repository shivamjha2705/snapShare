      ...
      <div className='flex xl-flex-row flex-col m-auto bg-white' style={{ maxWidth: '1000px', borderRadius: '32px' }}>
        ...
        <div className='w-full p-5 flex-1 xl:min-w-620'>
          <div className='flex items-center justify-between'>
            ...
            <a href={pinDetails.destination} target="_blank" rel="noreferrer" className='text-gray-600' >
              <h6 className='font-bold'> Image Link :-</h6> {pinDetails.destination.length > 40 ? `${pinDetails.destination.slice(10, 40)}...` : pinDetails.destination.slice(20)}
            </a>
          </div>
          <div>
          ...
          <Link to={`user-profile/${pinDetails.postedBy?._id}`} className='flex gap-2 mt-5 items-center bg-white p-2 rounded-lg'>
            <img
